...
# save all plots
# open png 
#png('/g/saka/Tatjana/data/02_pathway_analysis/progeny_decoupler/sct_normalized/pr_top_500/pw_acts_pval_smallerthan0.05_nocluster_prtop500.png', width = 4500, height = 3000, res = 300) 
...
for (idx in seq_along(plots)) {
  save_pheatmap_png(plots[[idx]], paste0("/g/saka/Tatjana/data/02_pathway_analysis/progeny_decoupler/sct_normalized/pr_top_500/heatmap_acts_unfiltered_", idx, ".png"))
}
...
# open png 
png("/g/saka/Tatjana/data/02_pathway_analysis/progeny_decoupler/sct_normalized/pr_top_500/progeny_pvals_top500.png", width = 4500, height = 3000, res = 300) 
...
for (idx in seq_along(plots_with_stats)) {
  ggsave(paste0("/g/saka/Tatjana/data/02_pathway_analysis/progeny_decoupler/sct_normalized/pr_top_500/violinplot_", idx, ".png"), plots_with_stats[[idx]], width = 5, height = 25, dpi = 300)
}
```
