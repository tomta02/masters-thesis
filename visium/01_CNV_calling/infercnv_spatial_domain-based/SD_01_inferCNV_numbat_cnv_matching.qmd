...
```{r}
# load output files
shared = read.csv("/g/saka/Tatjana/data/01_CNV_analysis/RESULTS_inferCNV_numbat_matching_per_spatial_domain/NEW_spatial_domain_prelim_growth2_long_cellgroupname_BMPN_0.3/LN0025/infercnv_numbat_matching.csv")
shared = shared[,-c(1)]
...
```{r}
numbat = read.csv("/g/saka/Tatjana/data/01_CNV_analysis/RESULTS_inferCNV_numbat_matching_per_spatial_domain/NEW_spatial_domain_prelim_growth2_long_cellgroupname_BMPN_0.3/LN0025/numbat_results.csv")
# gtrellis expects the integer nr. of the chromosome to be preceded by "chr"
numbat$CHROM = paste0("chr", numbat$CHROM)
```

```{r}
sicnv = read.csv("/g/saka/Tatjana/data/01_CNV_analysis/RESULTS_inferCNV_numbat_matching_per_spatial_domain/NEW_spatial_domain_prelim_growth2_long_cellgroupname_BMPN_0.3/LN0025/infercnv_results.csv")
...
names(sicnv_split) = c("diffuse_fdc_low", "interfollicular_malig_low", "other")
```
...
```{r}
pdf("/g/saka/Tatjana/data/01_CNV_analysis/RESULTS_inferCNV_numbat_matching_per_spatial_domain/NEW_spatial_domain_prelim_growth2_long_cellgroupname_BMPN_0.3/LN0025/gtrellis_plot_LN0025.pdf", width = 20, height = 8)
...
gtrellis_layout(
  ...
  track_ylab = c("shared", "numbat", "inferCNV_all", "diffuse_fdc_low", "interfollicular_malig_low", "other"), 
  track_axis = FALSE,
  xlab = "")
