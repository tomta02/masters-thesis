...
\
NOTE: regarding infercnv: this script works with infercnv data that was computed on a "per spatial domain-basis", i.e., CNVs were infered on 4 morphologically different regions of disease severity, as opposed to CNVs that were infered on a "per visium spot-basis".
