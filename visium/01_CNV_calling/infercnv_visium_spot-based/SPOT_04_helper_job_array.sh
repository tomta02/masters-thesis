...
CNV_clean="${DATA_DIR}/${EXT}/SPOT_02_cnvs_cleaned_binarized_p_0.9_wide.csv"

echo "Running job for $EXT"
Rscript /g/saka/Tatjana/analysis/visium/01_CNV_calling/infercnv_visium_spot-based/SPOT_03_data_wrangling_for_making_heatmaps.R "$DATA_DIR" "$CNV_clean" "$EXT"
