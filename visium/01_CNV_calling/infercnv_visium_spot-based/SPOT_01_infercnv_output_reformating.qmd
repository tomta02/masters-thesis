...
cnv_regs_spots_r = read.table("/scratch/tomek/01_siCNV/infercnv_outs_spotbased/NEW_spatial_doms_prelim_growth2/jobarray_all_pat_per_roi_spotbased_BMPN_0.5LN0438_MAAFHY1_R1/17_HMM_predHMMi6.hmm_mode-cells.pred_cnv_regions.dat", sep = "\t", header = TRUE)

# read in whole Visium spot-based mcmc infercnv object
mcmc_spots = readRDS("/scratch/tomek/01_siCNV/infercnv_outs_spotbased/NEW_spatial_doms_prelim_growth2/jobarray_all_pat_per_roi_spotbased_BMPN_0.5LN0438_MAAFHY1_R1/BayesNetOutput.HMMi6.hmm_mode-cells/MCMC_inferCNV_obj.rds")
...
```{r}
# save final result
write.table(cnvs_fin, "/g/saka/Tatjana/data/data_for_testing_stuff/prelim_cnv_analysis_spotbased/LN0438_MAAFHY1_R1_cnvs_extracted_from_mcmc_infcnvobj.cnv",
            row.names = FALSE,
            col.names = TRUE,
            sep = "\t")
