...
char_mat = readRDS("/g/saka/Tatjana/data/data_for_testing_stuff/0X_spot_based_cnv_plotting/LN0040HD_12BV2R_R1_cnv_char_mat_for_complexheatmap.rds")
```
...
png("/g/saka/Tatjana/data/data_for_testing_stuff/CNV_heatmap_test3.png", width = 8000, height = 1000, res = 300) 
